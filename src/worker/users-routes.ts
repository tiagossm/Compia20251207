...
import { requireScopes, protectSysAdmin, SCOPES, createAuthErrorResponse, isSystemAdmin, canManageUsers } from "./rbac-middleware";
...
usersRoutes.put("/admin/:id", authMiddleware, requireScopes(SCOPES.USERS_WRITE), protectSysAdmin(), async (c) => {
  ...
  try {
    ...
    if (targetUser.email === 'eng.tiagosm@gmail.com' || targetUser.id === '01990d69-5246-738d-8605-1ed319a3f98d') {
